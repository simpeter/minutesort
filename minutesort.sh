...
echo "Opening control connections to (${NODES[*]})..."
...
print("Sorted $RECORDS records (%.2f GB) in %u seconds => %.2f GB/minute, %.2f GB/s" % (tb, duration, (tb / duration) * 60, tb / duration))
EOF
    echo "---------------------"
fi
